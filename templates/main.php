...
<div id="magnet-div" class="mdui-textfield-has-bottom mdui-center mdui-col-lg-5 mdui-col-md-6 mdui-col-sm-10 mdui-col-xs-11" style="float: none">
                <form class="form-group" action="index.php" method="post">
                    <input id="url" name="url" type="url" class="mdui-textfield-input mdui-text-color-white mdui-p-r-4" autocomplete="on" placeholder="http://"
                           autofocus required/>
					<button id="clear" class="mdui-btn mdui-btn-icon mdui-ripple mdui-btn-dense" type="submit"><i class="mdui-icon material-icons mdui-text-color-white-icon">link</i></button>
                </form>
</div>
</div>
</div>
